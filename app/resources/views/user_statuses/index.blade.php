        ...
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                @can('create-user-status')
                    <a href="{{ route('user_statuses.create') }}" class="btn-success align-icon-btn">
                ...
                <tbody>
                    ...
                    @forelse ($userStatuses as $userStatus)
                        <tr class="table-row-body">
                            <td class="table-body">{{ $userStatus->id }}</td>
                            <td class="table-body">{{ $userStatus->status }}</td>
                            <td class="table-body table-actions">
                                ...
                                @can('destroy-user-status')
                                    <form action="{{ route('user_statuses.destroy', ['userStatus' => $userStatus->id]) }}"
                                        method="POST">
                                        @csrf
                                        @method('delete')
