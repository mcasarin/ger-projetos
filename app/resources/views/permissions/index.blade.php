...
<!-- Título e Trilha de Navegação -->
    <div class="content-wrapper">
        <div class="content-header">
            <h2 class="content-title">Permissões de Usuários</h2>
    ...
    <div class="content-box">
        <div class="content-box-header">
            <h3 class="content-box-title">Lista de Permissões</h3>
            @can('create-permission')
            <div class="content-box-btn">
                <a href="{{ route('permissions.create') }}" class="btn-success flex items-center space-x-1">
                    ...
                    <table class="table">
                        ...
                        <tr class="table-row-body">
                                ...
                                <td class="table-body table-actions">
                                    @can('show-permission')
                                    <a href="{{ route('permissions.show', ['permission' => $permission->id]) }}" class="btn-primary hidden md:flex items-center space-x-1">
                                        <!-- Ícone eye (Heroicons) -->
                                    ...
                                    <form id="delete-form-{{ $permission->id }}" action="{{ route('permissions.destroy', ['permission' => $permission->id]) }}" method="POST">
                                        ...
                                        <button type="button" class="btn-danger hidden md:flex items-center space-x-1" onclick="confirmDelete({{ $permission->id }})">
