    ...
    <div class="content-box">
        ...
        <!-- Início Formulário de Pesquisa -->
                <form class="form-search">
                    ...
                    <input type="text" name="name" class="form-input" placeholder="Pesquisa por nome" value="{{ $name }}">

                    <input type="text" name="email" class="form-input" placeholder="Pesquisa por e-mail" value="{{ $email }}">
                    ...
                    <div class="flex gap-1">
                        ...
                        <a href="{{ route('users.index') }}" type="submit" class="btn-warning flex items-center space-x-1">
                    ...
                    <table class="table">
                        <thead>
                            <tr class="table-row-header">
                                ...
                                <th class="table-header hidden lg:table-cell">E-mail</th>
                            ...
                            <tr class="table-row-body">
                                ...
                                <td class="table-body table-actions">
                                    ...
                                    <form id="delete-form-{{ $user->id }}" action="{{ route('users.destroy', ['user' => $user->id]) }}" method="POST">
                                        ...
                                        <button type="button" class="btn-danger hidden md:flex items-center space-x-1" onclick="confirmDelete({{ $user->id }})">
                                        <!-- Ícone trash (Heroicons) -->
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="size-5">
                                            <path stroke-linecap="round" stroke-linejoin="round"
