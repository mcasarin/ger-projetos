...
@section('content')
    ...
    <div class="content-box">
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                ...
                @can('edit-role')
                    <a href="{{ route('roles.edit', ['role' => $role->id]) }}" class="btn-warning align-icon-btn">
    ...
    <div class="detail-box">
            ...
            <div class="mb-1">
                ...
                <span class="detail-content">{{ \Carbon\Carbon::parse($role->created_at)->format('d/m/Y H:i:s') }}</span>
            </div>
