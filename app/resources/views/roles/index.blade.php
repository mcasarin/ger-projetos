...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <h2 class="content-title">Papéis de Usuários</h2>
                    ...
                    <table class="table">
                        ...
                        <tr class="table-row-body">
                                ...
                                <td class="table-body table-actions">
                                    ...
                                    <a href="{{ route('role-permission.index', ['role' => $role->id]) }}" class="btn-success flex items-center space-x-1">
                                        <!-- Ícone key (Heroicons) -->
                                    ...
                                    <a href="{{ route('roles.show', ['role' => $role->id]) }}"
                                        class="btn-primary hidden md:flex items-center space-x-1">
                                        <!-- Ícone eye (Heroicons) -->
                                    ...
                                    @endcan
                                    @can('destroy-role')
                                    <form id="delete-form-{{ $role->id }}" action="{{ route('roles.destroy', ['role' => $role->id]) }}" method="POST">
                                        @csrf
                                        @method('delete')

                                        <button type="button" class="btn-danger hidden md:flex items-center space-x-1" onclick="confirmDelete({{ $role->id }})">
