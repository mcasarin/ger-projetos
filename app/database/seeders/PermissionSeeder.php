    ...
    public function run(): void
    {
        try {
            ...
            $permissions = [
                ...
                ['title' => 'Deletar Usuários', 'name' => 'destroy-users'],
                ...
                ['title' => 'Listar Status de Tarefas', 'name' => 'index-status-tasks'],
                ['title' => 'Criar Status de Tarefas', 'name' => 'create-status-tasks'],
                ...
                ['title' => 'Auditoria de logs', 'name' => 'view-audit-logs'],
            ];
