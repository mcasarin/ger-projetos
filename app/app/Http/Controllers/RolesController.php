...
class RolesController extends Controller
{
    ...
    public function create()
    {
        ...
        // Salvar log
        Log::info('Acessando Criar um papel.', ['role_id' => $role->id, 'action_user_id' => Auth::id()]);
    }
    ...
    public function destroy(Role $role)
    {
        ...
        // Salvar log
        Log::info('A permissão do super admin não pode ser apagada.', ['role_id' => $role->id, 'action_user_id' => Auth::id()]);
        // redireciona com mensagem de erro
        return redirect()->route('roles.index')->with('error', 'A permissão do Super Admin não pode ser apagada.');
